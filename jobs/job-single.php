        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            ...
            <div class="bg-light p-3 border rounded">
              ...
              <div class="px-3">
                <a href="https://www.facebook.com/sharer/sharer.php?u=https://localhost/Taskify-2.0/jobs/job-single.php?id=<?php echo $row->id; ?>&quote=<?php echo $row->job_title; ?>" class="pt-3 pb-3 pr-3 pl-0"><span class="icon-facebook"></span></a>
